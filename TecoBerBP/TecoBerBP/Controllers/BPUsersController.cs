...
namespace TecoBerBP.Controllers
{
    ...
    public class BPUsersController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,NetUserId,Name,Email")] BPUser bPUser)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,NetUserId,Name,Email")] BPUser bPUser)
        {
            if (ModelState.IsValid)
            {
